...
var id = event.senderID;
 ...
 if (event.body.indexOf("OHID")==0 || (event.body.indexOf("Ohid vai")==0) || event.body.indexOf("ওহিদ ভাই")==0 ||
event.body.indexOf("Ohid bai")==0 ||
event.body.indexOf("ohid vai")==0 ||
event.body.indexOf("Ohid")==0 ||
event.body.indexOf("ওহিদ")==0 ||
event.body.indexOf("ohid")==0 ||
event.body.indexOf("অহিদ")==0 ||
event.body.indexOf("ওয়াহিদ")==0) {
